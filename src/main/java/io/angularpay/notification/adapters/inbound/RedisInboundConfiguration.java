...
import io.angularpay.notification.adapters.common.RedisConfiguration;
...
import static io.angularpay.notification.domain.AngularPayTopics.NOTIFICATIONS;
import static io.angularpay.notification.models.platform.PlatformConfigurationIdentifier.*;
...
public class RedisInboundConfiguration {
    ...
    ChannelTopic notificationsTopic() {
        return new ChannelTopic(NOTIFICATIONS.topic());
    }
    ...
    MessageListenerAdapter notificationsListenerAdapter(RedisMessageAdapter redisMessageAdapter) {
        return new MessageListenerAdapter(new NotificationMessageSubscriber(redisMessageAdapter, this.notificationsTopic()));
    }
    ...
    RedisMessageListenerContainer redisMessageListenerContainer(RedisMessageAdapter redisMessageAdapter, AngularPayConfiguration angularPayConfiguration) {
        ...
        // NOTIFICATIONS
        container.addMessageListener(notificationsListenerAdapter(redisMessageAdapter), notificationsTopic());
