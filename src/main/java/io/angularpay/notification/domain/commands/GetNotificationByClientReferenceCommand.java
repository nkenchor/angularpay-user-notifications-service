...
@Service
public class GetNotificationByClientReferenceCommand extends AbstractCommand<GenericByReferenceCommandRequest, Notification> {

    private final MongoAdapter mongoAdapter;
    private final DefaultConstraintValidator validator;

    public GetNotificationByClientReferenceCommand(
            ObjectMapper mapper,
            MongoAdapter mongoAdapter,
            DefaultConstraintValidator validator) {
        super("GetNotificationByClientReferenceCommand", mapper);
    ...
    protected Notification handle(GenericByReferenceCommandRequest request) {
        return this.mongoAdapter.findNotificationByClientReference(request.getReference())
